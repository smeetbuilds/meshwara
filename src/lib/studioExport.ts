import { resolveStudioRig, resolveStudioTimeline, type StudioNode, type StudioProject } from './studioProject'
...
export interface MeshvaraStudioConfigObject {
  ...
  rig?: ReturnType<typeof resolveStudioRig>
