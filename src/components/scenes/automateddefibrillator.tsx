...
function AutomatedDefibrillator(){return <group rotation={[0,-.35,0]}>
  <RoundedBox args={[2,1.55,.8]} radius={.15} smoothness={6}><meshPhysicalMaterial color="#d2d2cc" roughness={.5} clearcoat={.22}/></RoundedBox>
  <RoundedBox args={[1.28,.5,.045]} radius={.05} smoothness={5} position={[0,.3,.43]}><meshPhysicalMaterial color="#20343a" roughness={.16} clearcoat={.55}/></RoundedBox>
  <RoundedBox args={[.32,.22,.05]} radius={.065} smoothness={5} position={[-.58,-.38,.43]}><meshPhysicalMaterial color="#bc5146" roughness={.34}/></RoundedBox>
  <RoundedBox args={[1.1,.22,.3]} radius={.08} smoothness={5} position={[0,.93,0]}><meshPhysicalMaterial color="#6e7779" metalness={.65} roughness={.3}/></RoundedBox>
