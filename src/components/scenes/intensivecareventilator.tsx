...
function IcuVentilator(){return <group position={[0,.65,0]} rotation={[0,-.35,0]}>
  <CurvedBox args={[1.75,1.65,.82]} radius={.13} smoothness={6} position={[0,.35,0]}><meshPhysicalMaterial color="#d1d2ce" roughness={.48} clearcoat={.18}/></CurvedBox>
  <CurvedBox args={[1.28,.82,.05]} radius={.06} smoothness={5} position={[0,.55,.44]}><meshPhysicalMaterial color="#173039" roughness={.14} clearcoat={.6}/></CurvedBox>
  ...
  <CurvedBox args={[1.1,.12,.75]} radius={.04} smoothness={5} position={[0,-1.72,0]}><meshPhysicalMaterial color="#656f72" metalness={.72} roughness={.28}/></CurvedBox>
