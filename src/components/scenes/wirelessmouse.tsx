...
function WirelessMouse(){
  return <group rotation={[.18,-.34,-.05]}>
    <RoundedBox args={[1.38,.55,2.18]} radius={.38} smoothness={8}><meshPhysicalMaterial color="#d7d8d5" roughness={.34} clearcoat={.6}/></RoundedBox>
    <RoundedBox args={[1.16,.08,.92]} radius={.28} smoothness={7} position={[0,.31,-.42]}><meshPhysicalMaterial color="#e2e3df" roughness={.28} clearcoat={.5}/></RoundedBox>
    ...
    <RoundedBox args={[.42,.045,.16]} radius={.05} smoothness={4} position={[0,.34,.56]}><meshStandardMaterial color="#bec0bd" roughness={.42}/></RoundedBox>
