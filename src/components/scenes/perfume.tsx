...
function PerfumeVessel() {
  ...
  return (
    <group ref={ref} rotation={[0.03, -0.28, -0.04]} position={[0, -0.2, 0]}>
      <RoundedBox args={[1.62, 2.25, 0.72]} radius={0.23} smoothness={10}>
        <MeshTransmissionMaterial transmission={0.97} thickness={0.48} roughness={0.06} ior={1.5} chromaticAberration={0.018} color="#e9eef0" />
      </RoundedBox>
      <RoundedBox args={[1.38, 1.48, 0.52]} radius={0.17} smoothness={8} position={[0, -0.25, 0]}>
      ...
      <RoundedBox args={[0.7, 0.68, 0.62]} radius={0.12} smoothness={6} position={[0, 1.72, 0]}>
        <meshPhysicalMaterial color="#17191a" metalness={0.75} roughness={0.24} clearcoat={0.4} />
      </RoundedBox>
      <RoundedBox args={[0.82, 0.5, 0.04]} radius={0.035} smoothness={4} position={[0, -0.08, 0.39]}>
