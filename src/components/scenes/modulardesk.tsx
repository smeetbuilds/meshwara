...
function ModularDesk() {
  return (
    <group rotation={[0.04, -0.38, 0]} position={[0, -0.5, 0]}>
      <CurvedBox args={[3.25, 0.18, 1.18]} radius={0.06} smoothness={5} position={[0, 0.62, 0]}><meshPhysicalMaterial color="#a37d5b" roughness={0.5} /></CurvedBox>
      ...
      <CurvedBox args={[1.05, 0.5, 0.78]} radius={0.07} smoothness={5} position={[-0.72, 0.28, 0]}><meshPhysicalMaterial color="#353a3d" metalness={0.65} roughness={0.3} /></CurvedBox>
      ...
      <CurvedBox args={[0.9, 0.06, 0.32]} radius={0.025} smoothness={4} position={[0.45, 0.76, 0.38]}><meshPhysicalMaterial color="#d7d4cd" roughness={0.44} /></CurvedBox>
