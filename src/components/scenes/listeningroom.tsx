    ...
    <group rotation={[0.04, -0.28, 0]} position={[0, -0.62, 0]} scale={0.9}>
      ...
      {[-1.42, 1.42].map((x) => (
        <group key={x} position={[x, -0.3, -0.72]}>
          <CurvedBox args={[0.68, 1.82, 0.58]} radius={0.16} smoothness={7}><meshPhysicalMaterial color="#222527" metalness={0.62} roughness={0.3} /></CurvedBox>
      ...
      <CurvedBox args={[1.65, 0.34, 0.82]} radius={0.14} smoothness={7} position={[0, -0.68, 0.45]}><meshPhysicalMaterial color="#aa8465" roughness={0.52} /></CurvedBox>
      <CurvedBox args={[1.55, 1.0, 0.25]} radius={0.13} smoothness={7} position={[0, 0.02, 0.12]} rotation={[-0.12, 0, 0]}><meshPhysicalMaterial color="#b49a83" roughness={0.6} sheen={0.45} /></CurvedBox>
      <CurvedBox args={[1.32, 0.22, 0.54]} radius={0.06} smoothness={5} position={[0, -0.83, -0.72]}><meshPhysicalMaterial color="#6e543f" roughness={0.5} /></CurvedBox>
