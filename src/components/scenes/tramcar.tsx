...
function TramCar(){return <group position={[0,-.82,0]} rotation={[0,-.36,0]} scale={.86}>
  <CurvedBox args={[3.6,1.75,1.45]} radius={.22} smoothness={5} position={[0,.45,0]}><meshPhysicalMaterial color="#b88a4d" metalness={.42} roughness={.31} clearcoat={.3}/></CurvedBox>
  <CurvedBox args={[3.24,.72,1.49]} radius={.12} smoothness={4} position={[0,.78,0]}><meshPhysicalMaterial color="#263238" roughness={.24}/></CurvedBox>
