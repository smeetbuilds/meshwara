...
function MicroplateReader(){
  return <group position={[0,-.1,0]} rotation={[0,-.38,0]}>
    <RoundedBox args={[2.45,1.25,1.9]} radius={.18} smoothness={6}><meshPhysicalMaterial color="#d8d8d3" roughness={.4} clearcoat={.28}/></RoundedBox>
    <RoundedBox args={[1.72,.14,1.08]} radius={.08} smoothness={5} position={[0,-.28,.97]}><meshPhysicalMaterial color="#303638" metalness={.28} roughness={.3}/></RoundedBox>
    <RoundedBox args={[1.38,.035,.82]} radius={.05} smoothness={4} position={[0,-.19,1.07]}><meshStandardMaterial color="#151b1d" roughness={.24}/></RoundedBox>
    <RoundedBox args={[.9,.035,.42]} radius={.04} smoothness={4} position={[.45,.4,.96]}><meshPhysicalMaterial color="#253437" roughness={.18} clearcoat={.6}/></RoundedBox>
