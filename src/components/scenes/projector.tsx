...
function CompactProjector(){return <group rotation={[.15,-.4,0]} position={[0,-.1,0]}>
  <RoundedBox args={[2.7,1.55,1.9]} radius={.2} smoothness={5}><meshPhysicalMaterial color="#e4e1da" roughness={.3} metalness={.08}/></RoundedBox>
  ...
  <RoundedBox args={[1.5,.18,.92]} radius={.08} smoothness={3} position={[0,-.86,-.05]}><meshPhysicalMaterial color="#282a2a" roughness={.5}/></RoundedBox>
</group>}
