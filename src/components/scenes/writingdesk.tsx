...
function WritingDesk(){return <group position={[0,-.7,0]} rotation={[0,-.34,0]}>
  <RoundedBox args={[3.3,.18,1.55]} radius={.08} smoothness={4} position={[0,.7,0]}><meshPhysicalMaterial color="#8c6748" roughness={.34}/></RoundedBox>
  <RoundedBox args={[1.55,.035,.85]} radius={.04} smoothness={4} position={[-.42,.805,.05]}><meshStandardMaterial color="#493d35" roughness={.62}/></RoundedBox>
  <RoundedBox args={[1.15,.28,1.28]} radius={.05} smoothness={4} position={[.86,.5,0]}><meshStandardMaterial color="#76563f" roughness={.38}/></RoundedBox>
