...
function UVVisSpectrophotometer(){
  return <group position={[0,-.2,0]} rotation={[0,-.35,0]}>
    <RoundedBox args={[2.7,1.35,1.85]} radius={.18} smoothness={6}><meshPhysicalMaterial color="#d9dad6" roughness={.38} clearcoat={.3}/></RoundedBox>
    <RoundedBox args={[1.45,.13,1.15]} radius={.07} smoothness={5} position={[-.42,.18,.9]}><meshPhysicalMaterial color="#2e3436" metalness={.22} roughness={.28}/></RoundedBox>
    <RoundedBox args={[.92,.035,.46]} radius={.04} smoothness={4} position={[.68,.43,.95]}><meshPhysicalMaterial color="#1e2b2f" roughness={.16} clearcoat={.65}/></RoundedBox>
    ...
    <RoundedBox args={[.48,.08,.52]} radius={.045} smoothness={4} position={[-.68,.38,.98]}><meshStandardMaterial color="#0f1719" roughness={.26}/></RoundedBox>
