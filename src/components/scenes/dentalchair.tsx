...
function DentalChair(){return <group position={[0,-.76,0]} rotation={[0,-.3,0]}>
  ...
  <CurvedBox args={[1.5,.28,.72]} radius={.18} smoothness={8} position={[.05,-.18,0]} rotation={[0,0,-.12]}><meshPhysicalMaterial color="#95b9b2" roughness={.46} sheen={.3} /></CurvedBox>
  <CurvedBox args={[1.18,.28,.72]} radius={.18} smoothness={8} position={[-.83,.45,0]} rotation={[0,0,.66]}><meshPhysicalMaterial color="#9bc0b9" roughness={.46} sheen={.3} /></CurvedBox>
  <CurvedBox args={[.5,.2,.66]} radius={.14} smoothness={7} position={[-1.18,.92,0]} rotation={[0,0,.46]}><meshPhysicalMaterial color="#a5c8c2" roughness={.45} /></CurvedBox>
