...
function LaboratoryScene(){return <group position={[0,-.8,0]} rotation={[.03,-.3,0]} scale={.92}>
  ...
  <RoundedBox args={[3.25,.18,.85]} radius={.06} smoothness={4} position={[0,-.22,-.5]}><meshPhysicalMaterial color="#70797c" metalness={.35} roughness={.38} /></RoundedBox>
  ...
  <RoundedBox args={[.88,.12,.5]} radius={.04} smoothness={4} position={[1.1,-.53,.42]}><meshPhysicalMaterial color="#4d5558" metalness={.55} roughness={.35} /></RoundedBox>
