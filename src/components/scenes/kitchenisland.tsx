...
function KitchenIsland(){return <group position={[0,-.82,0]} rotation={[.03,-.3,0]} scale={.92}>
  ...
  <RoundedBox args={[2.65,1.0,1.1]} radius={.08} smoothness={5} position={[0,-.15,0]}><meshPhysicalMaterial color="#665347" roughness={.48} /></RoundedBox>
  <RoundedBox args={[2.9,.12,1.32]} radius={.06} smoothness={5} position={[0,.38,0]}><meshPhysicalMaterial color="#d7d2ca" roughness={.28} /></RoundedBox>
