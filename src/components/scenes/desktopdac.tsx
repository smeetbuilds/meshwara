...
function DesktopDAC(){return <group position={[0,-.4,0]} rotation={[0,-.34,0]}>
  <CurvedBox args={[2.65,.72,1.55]} radius={.12} smoothness={5}><meshPhysicalMaterial color="#353a3d" metalness={.76} roughness={.24}/></CurvedBox>
  <CurvedBox args={[2.45,.5,.04]} radius={.05} smoothness={4} position={[0,0,.795]}><meshStandardMaterial color="#171a1c" roughness={.3}/></CurvedBox>
