...
function PulseOximeter(){
  return <group rotation={[.05,-.34,-.04]}>
    <RoundedBox args={[1.35,.5,2.2]} radius={.24} smoothness={7}><meshPhysicalMaterial color="#d8d9d5" roughness={.34} clearcoat={.55}/></RoundedBox>
    <RoundedBox args={[1.02,.03,1.05]} radius={.09} smoothness={5} position={[0,.267,-.28]}><meshPhysicalMaterial color="#182426" roughness={.16} clearcoat={.7}/></RoundedBox>
    <RoundedBox args={[.42,.035,.15]} radius={.04} smoothness={4} position={[0,.272,.52]}><meshStandardMaterial color="#85d7b9" emissive="#3d7f6b" emissiveIntensity={1.3}/></RoundedBox>
    ...
    <RoundedBox args={[.92,.05,.26]} radius={.05} smoothness={4} position={[0,-.276,-.85]}><meshStandardMaterial color="#adb0ac" roughness={.62}/></RoundedBox>
