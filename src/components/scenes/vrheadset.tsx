...
function SpatialHeadset(){return <group position={[0,-.1,0]} rotation={[.08,-.36,0]}>
  <CurvedBox args={[2.75,1.05,.58]} radius={.36} smoothness={8}><meshPhysicalMaterial color="#d7dadc" metalness={.28} roughness={.18} clearcoat={.75}/></CurvedBox>
  <CurvedBox args={[2.45,.82,.035]} radius={.31} smoothness={7} position={[0,.03,.31]}><meshPhysicalMaterial color="#18252e" metalness={.35} roughness={.05} clearcoat={1}/></CurvedBox>
