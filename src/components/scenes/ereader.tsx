...
function EReader(){
  return <group rotation={[0.08,-0.3,-0.02]}>
    <RoundedBox args={[1.86,.13,2.62]} radius={.16} smoothness={6}><meshPhysicalMaterial color="#2b3032" metalness={.55} roughness={.28} clearcoat={.45}/></RoundedBox>
    <RoundedBox args={[1.53,.026,2.2]} radius={.07} smoothness={5} position={[0,.078,-.01]}><meshPhysicalMaterial color="#d8d6cd" roughness={.82}/></RoundedBox>
    ...
    <RoundedBox args={[.7,.018,.035]} radius={.012} smoothness={3} position={[0,.096,.42]}><meshStandardMaterial color="#b8b6ad" roughness={.9}/></RoundedBox>
  </group>
}
