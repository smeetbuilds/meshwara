...
function PatientMonitor(){return <group position={[0,.45,0]} rotation={[0,-.35,0]}>
  <RoundedBox args={[1.8,1.45,.55]} radius={.12} smoothness={6} position={[0,.55,0]}><meshPhysicalMaterial color="#d2d3d0" roughness={.48} clearcoat={.2}/></RoundedBox>
  <RoundedBox args={[1.4,.95,.04]} radius={.05} smoothness={5} position={[0,.55,.3]}><meshPhysicalMaterial color="#132a31" roughness={.12} clearcoat={.6}/></RoundedBox>
  ...
  <RoundedBox args={[1,.12,.65]} radius={.04} smoothness={5} position={[0,-1.35,0]}><meshPhysicalMaterial color="#626c6f" metalness={.7} roughness={.3}/></RoundedBox>
