...
function FieldCamera() {
  ...
  return (
    <group ref={ref} rotation={[0.08, -0.38, 0]}>
      <RoundedBox args={[2.5, 1.55, 0.82]} radius={0.18} smoothness={8}><meshPhysicalMaterial color="#24272a" metalness={0.68} roughness={0.28} clearcoat={0.46} /></RoundedBox>
      ...
      <RoundedBox args={[0.76, 0.42, 0.38]} radius={0.08} smoothness={5} position={[-0.55, 0.72, -0.02]}><meshPhysicalMaterial color="#33383b" metalness={0.72} roughness={0.28} /></RoundedBox>
      ...
      <RoundedBox args={[0.42, 0.82, 0.16]} radius={0.08} smoothness={5} position={[-1.27, -0.1, 0]}><meshPhysicalMaterial color="#17191b" roughness={0.46} /></RoundedBox>
    </group>
  )
}
