...
function SignetRing(){return <group rotation={[.35,-.4,.22]}>
  ...
  <RoundedBox args={[1.02,.34,.72]} radius={.14} smoothness={8} position={[0,.84,0]} rotation={[0,0,.02]}><meshPhysicalMaterial color="#d5b86e" metalness={1} roughness={.12} clearcoat={.7} /></RoundedBox>
  <RoundedBox args={[.7,.035,.43]} radius={.08} smoothness={6} position={[0,1.03,.02]}><meshPhysicalMaterial color="#1c2528" metalness={.72} roughness={.16} /></RoundedBox>
