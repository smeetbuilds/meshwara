...
function PortableSSD(){
  return <group rotation={[.18,-.38,-.06]}>
    <RoundedBox args={[2.15,.36,1.34]} radius={.2} smoothness={7}><meshPhysicalMaterial color="#25292b" metalness={.75} roughness={.22} clearcoat={.5}/></RoundedBox>
    <RoundedBox args={[1.78,.025,1.02]} radius={.09} smoothness={5} position={[0,.196,0]}><meshPhysicalMaterial color="#343a3d" metalness={.52} roughness={.33}/></RoundedBox>
    ...
    <RoundedBox args={[.48,.1,.18]} radius={.04} smoothness={4} position={[1.09,0,0]}><meshPhysicalMaterial color="#090b0c" metalness={.4} roughness={.32}/></RoundedBox>
