...
function Smartwatch(){return <group rotation={[.18,-.32,.08]}>
  <RoundedBox args={[1.65,1.9,.38]} radius={.32} smoothness={6}><meshPhysicalMaterial color="#888d91" metalness={1} roughness={.17} clearcoat={.9}/></RoundedBox>
  <RoundedBox args={[1.48,1.72,.035]} radius={.27} smoothness={5} position={[0,0,.21]}><meshPhysicalMaterial color="#090b0d" roughness={.14} clearcoat={1}/></RoundedBox>
  ...
  {[-1,1].map(side=><RoundedBox key={side} args={[1.08,1.75,.18]} radius={.12} smoothness={4} position={[0,side*1.72,-.05]}><meshPhysicalMaterial color="#333637" roughness={.58}/></RoundedBox>)}
