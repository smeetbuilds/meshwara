...
function DiagnosticScanner(){return <group position={[0,-.72,0]} rotation={[0,-.32,0]}>
  ...
  <CurvedBox args={[.82,.18,2.4]} radius={.08} smoothness={5} position={[0,-.88,.72]}><meshPhysicalMaterial color="#eff2f1" roughness={.32} /></CurvedBox>
  <CurvedBox args={[.72,.13,1.75]} radius={.06} smoothness={4} position={[0,-.72,.65]}><meshPhysicalMaterial color="#b8c3c3" roughness={.42} /></CurvedBox>
