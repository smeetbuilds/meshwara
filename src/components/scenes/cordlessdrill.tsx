...
function CordlessDrill(){return <group rotation={[.05,-.52,-.05]} position={[0,-.25,0]}>
  <RoundedBox args={[1.75,1.25,1.1]} radius={.28} smoothness={5} position={[0,.82,0]}><meshPhysicalMaterial color="#d9ad35" roughness={.34}/></RoundedBox>
  ...
  <RoundedBox args={[.65,1.65,.7]} radius={.18} smoothness={4} position={[-.25,-.38,0]} rotation={[0,0,.17]}><meshPhysicalMaterial color="#2e3233" roughness={.45}/></RoundedBox>
  <RoundedBox args={[1.05,.55,.88]} radius={.15} smoothness={4} position={[-.15,-1.3,0]}><meshPhysicalMaterial color="#202425" roughness={.48}/></RoundedBox>
