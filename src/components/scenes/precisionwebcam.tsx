...
function PrecisionWebcam(){return <group position={[0,-.1,0]} rotation={[0,-.36,0]}>
  <CurvedBox args={[2.25,.78,.64]} radius={.27} smoothness={7}><meshPhysicalMaterial color="#33383b" metalness={.7} roughness={.22}/></CurvedBox>
  ...
  <group position={[0,-.63,-.12]}><CurvedBox args={[1.25,.18,.72]} radius={.09} smoothness={4}><meshStandardMaterial color="#44494b" roughness={.34}/></CurvedBox><CurvedBox args={[1.1,.1,.55]} radius={.07} smoothness={4} position={[0,-.18,.15]}><meshStandardMaterial color="#2c3032"/></CurvedBox></group>
