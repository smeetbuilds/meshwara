...
function MeditationCourtyard(){return <group position={[0,-.82,0]} rotation={[.04,-.28,0]} scale={.92}>
  ...
  <RoundedBox args={[1.75,.08,.92]} radius={.06} smoothness={4} position={[.62,-.61,.35]}><MeshTransmissionMaterial transmission={.72} thickness={.1} roughness={.18} ior={1.34} color="#8fb8b4" /></RoundedBox>
  <RoundedBox args={[1.2,.16,.46]} radius={.06} smoothness={5} position={[-.38,-.48,.72]}><meshPhysicalMaterial color="#865f43" roughness={.5} /></RoundedBox>
