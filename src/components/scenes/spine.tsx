  ...
  return (
    <group ref={ref} rotation={[0.15, -0.2, -0.14]}>
      {Array.from({ length: 9 }).map((_, i) => (
        <CurvedBox key={i} args={[1.8 - i * 0.08, 0.32, 0.78]} radius={0.12} smoothness={5} position={[Math.sin(i * 0.65) * 0.3, (i - 4) * 0.38, Math.cos(i * 0.5) * 0.22]} rotation={[0, i * 0.18, i * 0.035]}>
