...
function MirrorlessCamera(){return <group rotation={[0,-.42,0]} position={[0,-.2,0]}>
  <RoundedBox args={[2.35,1.42,.72]} radius={.16} smoothness={6}><meshPhysicalMaterial color="#272a2c" metalness={.68} roughness={.24} clearcoat={.65}/></RoundedBox>
  <RoundedBox args={[.56,1.22,.86]} radius={.15} smoothness={5} position={[-.88,-.05,.05]}><meshPhysicalMaterial color="#202326" roughness={.32}/></RoundedBox>
