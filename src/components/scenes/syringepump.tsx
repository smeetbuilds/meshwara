...
function SyringePump(){return <group position={[0,.05,0]} rotation={[0,-.32,0]}>
  <CurvedBox args={[2.2,.78,1]} radius={.11} smoothness={6} position={[0,-.1,0]}><meshPhysicalMaterial color="#d3d4d0" roughness={.48} clearcoat={.18}/></CurvedBox>
  ...
  <CurvedBox args={[.2,.45,.08]} radius={.04} smoothness={5} position={[-.9,.05,.55]}><meshPhysicalMaterial color="#657277" metalness={.6} roughness={.3}/></CurvedBox>
  <CurvedBox args={[.48,.32,.05]} radius={.03} smoothness={5} position={[.65,.12,.53]}><meshPhysicalMaterial color="#19323a" roughness={.16} clearcoat={.5}/></CurvedBox>
