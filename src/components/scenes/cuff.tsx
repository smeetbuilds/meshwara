...
function SculpturalCuff(){return <group rotation={[.34,-.4,.18]}>
  ...
  {[-.72,.72].map((x,i)=><CurvedBox key={x} args={[.28,.42,.34]} radius={.12} smoothness={7} position={[x,-.57,0]} rotation={[0,0,i?-.38:.38]}><meshPhysicalMaterial color="#d1b16a" metalness={1} roughness={.12} /></CurvedBox>)}
