...
function CarryCase() {
  return (
    <group rotation={[0.04, -0.42, -0.02]} position={[0, -0.12, 0]}>
      <CurvedBox args={[1.75, 2.4, 0.72]} radius={0.24} smoothness={9}>
      ...
      <CurvedBox args={[0.82, 0.12, 0.16]} radius={0.05} smoothness={5} position={[0, 1.38, 0]}><meshPhysicalMaterial color="#9a7d59" metalness={0.85} roughness={0.22} /></CurvedBox>
      ...
      <CurvedBox args={[0.7, 0.09, 0.13]} radius={0.04} smoothness={4} position={[0, 1.94, 0]}><meshPhysicalMaterial color="#25282a" roughness={0.35} /></CurvedBox>
