...
function LabIncubator(){
  return <group position={[0,-.1,0]} rotation={[0,-.34,0]}>
    <RoundedBox args={[2.25,2.1,1.75]} radius={.15} smoothness={6}><meshPhysicalMaterial color="#d7d9d7" roughness={.4} clearcoat={.28}/></RoundedBox>
    <RoundedBox args={[1.72,1.38,.055]} radius={.08} smoothness={5} position={[0,-.08,.9]}><meshPhysicalMaterial color="#233033" transmission={.08} transparent opacity={.82} roughness={.18}/></RoundedBox>
    <RoundedBox args={[1.38,1.02,.03]} radius={.05} smoothness={4} position={[0,-.08,.94]}><meshStandardMaterial color="#111719" transparent opacity={.26}/></RoundedBox>
    <RoundedBox args={[.78,.035,.32]} radius={.035} smoothness={4} position={[.42,.72,.92]}><meshStandardMaterial color="#223235" roughness={.2}/></RoundedBox>
