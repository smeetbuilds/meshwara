...
function LoungeOttoman(){return <group position={[0,-.7,0]} rotation={[.02,-.4,0]}>
  <RoundedBox args={[2.3,.78,1.48]} radius={.28} smoothness={8}><meshPhysicalMaterial color="#b9a68e" roughness={.62} sheen={.36} sheenColor="#ead8bf" /></RoundedBox>
  <RoundedBox args={[2.06,.2,1.25]} radius={.18} smoothness={6} position={[0,.45,0]}><meshPhysicalMaterial color="#c7b59e" roughness={.58} sheen={.3}/></RoundedBox>
