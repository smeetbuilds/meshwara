...
function RailCoupler(){return <group rotation={[0,-.3,0]}>
  <RoundedBox args={[1.3,.85,.7]} radius={.16} smoothness={6} position={[0,.05,0]}><meshPhysicalMaterial color="#555d60" metalness={.85} roughness={.28}/></RoundedBox>
  <RoundedBox args={[.75,.52,1]} radius={.12} smoothness={5} position={[.72,.05,0]}><meshPhysicalMaterial color="#626a6d" metalness={.85} roughness={.26}/></RoundedBox>
  ...
  <RoundedBox args={[.9,.28,1.05]} radius={.06} smoothness={5} position={[-1.45,.05,0]}><meshPhysicalMaterial color="#4d5659" metalness={.8} roughness={.28}/></RoundedBox>
