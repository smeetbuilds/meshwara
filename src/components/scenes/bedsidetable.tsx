...
function BedsideTable(){return <group rotation={[.04,-.38,0]} position={[0,-.45,0]}>
  <CurvedBox args={[1.8,1.35,1.35]} radius={.12} smoothness={4}><meshPhysicalMaterial color="#d8d0c2" roughness={.5}/></CurvedBox>
  <CurvedBox args={[1.52,.47,1.22]} radius={.06} smoothness={3} position={[0,.3,.08]}><meshPhysicalMaterial color="#b5a994" roughness={.52}/></CurvedBox>
