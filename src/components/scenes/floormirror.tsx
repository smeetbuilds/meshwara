...
function FloorMirror(){
  return <group position={[0,-.5,0]} rotation={[0,-.28,0]}>
    <RoundedBox args={[1.72,3.35,.16]} radius={.18} smoothness={7} position={[0,.78,0]}><meshPhysicalMaterial color="#292b2c" metalness={.82} roughness={.22}/></RoundedBox>
    <RoundedBox args={[1.48,3.1,.025]} radius={.13} smoothness={6} position={[0,.78,.095]}><meshPhysicalMaterial color="#bec8ca" metalness={.96} roughness={.06} clearcoat={1}/></RoundedBox>
