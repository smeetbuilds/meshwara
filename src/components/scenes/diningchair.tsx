...
function CantileverDiningChair(){return <group position={[0,-.7,0]} rotation={[0,-.38,0]}>
  <CurvedBox args={[1.28,.22,1.1]} radius={.16} smoothness={7} position={[0,-.24,0]} rotation={[-.05,0,0]}><meshPhysicalMaterial color="#b08266" roughness={.48} sheen={.35} /></CurvedBox>
  <CurvedBox args={[1.22,1.05,.2]} radius={.14} smoothness={7} position={[0,.56,-.48]} rotation={[-.12,0,0]}><meshPhysicalMaterial color="#b98b6d" roughness={.48} sheen={.32} /></CurvedBox>
