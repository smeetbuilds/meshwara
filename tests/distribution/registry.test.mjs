...
const source = {
  brand: 'MESHVARA', packSchemaVersion: 1, count: 2, assets: [
...
assert.equal(normalized.packSchemaVersion, 1)
...
assert.equal(normalizeRegistry(registry).packSchemaVersion, 1)
